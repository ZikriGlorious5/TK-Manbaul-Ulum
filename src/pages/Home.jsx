...
const howSteps = [
  { icon: '📋', label: 'Daftar & Seleksi', desc: 'Hubungi kami untuk info PPDB dan jadwal seleksi' },
  { icon: '🏫', label: 'Masa Perkenalan', desc: 'MPLS — adaptasi lingkungan sekolah bersama guru' },
  { icon: '🎮', label: 'Merdeka Bermain', desc: 'Belajar lewat bermain bermakna di 4 sentra' },
  { icon: '🌟', label: 'Tumbuh & Berkembang', desc: 'Anak siap melanjutkan ke jenjang pendidikan dasar' },
];

const fasilitasList = [
  { label: 'Smartboard Interaktif', desc: 'Media belajar digital di setiap kelas' },
  { label: 'Ayunan (3 unit)', desc: 'Area bermain motorik kasar' },
  { label: 'Trampolin', desc: 'Stimulasi keseimbangan tubuh anak' },
  { label: 'Sepeda (4 unit) & Skuter (4 unit)', desc: 'Melatih koordinasi dan keberanian' },
  { label: 'Papan Luncur & Jungkat-jungkit', desc: 'Playground lengkap dan aman' },
  { label: 'Pojok Baca (2 unit)', desc: 'Menumbuhkan minat literasi sejak dini' },
];

const sentraList = [
  { icon: '🎨', name: 'Sentra Seni', desc: 'Mengembangkan kreativitas dan ekspresi diri melalui melukis, kolase, dan kerajinan.' },
  { icon: '🕌', name: 'Sentra Imtaq', desc: 'Penanaman nilai agama Islam, hafalan doa, surat pendek, dan pembiasaan ibadah.' },
  { icon: '✏️', name: 'Sentra Persiapan', desc: 'Pengenalan literasi, numerasi, dan kesiapan memasuki pendidikan dasar.' },
  { icon: '🌿', name: 'Kelas Bahan Alam', desc: 'Eksplorasi alam sekitar, sains sederhana, dan kecintaan lingkungan hidup.' },
];
    ...
    <>
      ...
      <main>
        ...
        <section className="relative overflow-hidden flex items-center min-h-[88vh] py-[60px] bg-gradient-to-br from-[#1b4332] via-[#2d6a4f] to-[#a8d8b0]">
          ...
          <div
            className="absolute rounded-full opacity-[0.18] pointer-events-none bg-white"
            style={{ width: 120, height: 120, bottom: '20%', left: '3%' }}
          />
          ...
          <div className="relative z-[2] max-w-[1100px] mx-auto px-7 flex items-center gap-10 flex-wrap">
            <div className="flex-1 min-w-[340px] text-white">
              ...
              >
                Selamat Datang di<br />TK Manbaul Ulum
              </h1>
              <p
                data-reveal="up"
                data-delay="1"
              ...
              >
                Membentuk generasi cerdas, mandiri, dan berakhlakul karimah sejak usia dini.<br />
                Berdiri sejak 1993 di Ciampea, Kabupaten Bogor.
              </p>
              <div className="flex gap-3.5 flex-wrap" data-reveal="up" data-delay="2">
                <Link
                  to="/kontak"
        ...
        <section className="py-[70px] bg-white">
          <div className="max-w-[1100px] mx-auto px-7">
            ...
            <p
              ...
              data-delay="1"
            >
              Proses pendaftaran mudah dan transparan — kami siap membantu setiap langkahnya
            </p>
            <div className="grid gap-5 mt-9" style={{ gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))' }}>
              {howSteps.map((s, i) => (
                <div
                ...
                >
                  ...
                  <div className="text-[52px] my-2.5 mb-3.5">{s.icon}</div>
                  <h3 className="font-fredoka text-base text-brown-text uppercase tracking-wide">{s.label}</h3>
                  <p className="text-[13px] text-[#666] mt-2 font-semibold">{s.desc}</p>
                </div>
              ))}
            </div>
          </div>
        ...
        <section className="py-[70px] bg-cream">
          <div className="max-w-[1100px] mx-auto px-7">
            <div className="grid gap-8" style={{ gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))' }}>
              <div className="bg-[#e8f5e9] border-2 border-[#c8e6c9] rounded shadow-card p-7" data-reveal="left">
                <h2 className="font-fredoka text-2xl text-green-dark mb-3">Tentang TK Manbaul Ulum</h2>
                <p className="text-[15px] text-[#555] mb-3">
                  Didirikan tahun <strong>1993</strong> di bawah naungan Yayasan Pendidikan Islam Manbaul Ulum,
                  TK Manbaul Ulum telah melayani pendidikan anak usia dini di Kp. Gedong, Ciampea, Kabupaten Bogor selama lebih dari 30 tahun.
                </p>
                <h3 className="text-[15px] font-extrabold text-green-mid mt-4 mb-2">📊 Data Sekolah 2025/2026</h3>
                <ul>
                  ...
                  <li className="text-sm text-[#555] py-1.5 border-b border-cream-dark flex items-center gap-2 before:content-['✔'] before:text-green-mid before:font-extrabold before:text-xs">
                    Siswa aktif: <strong>54 siswa</strong> (31 L, 23 P)
                  </li>
                  <li className="text-sm text-[#555] py-1.5 border-b border-cream-dark flex items-center gap-2 before:content-['✔'] before:text-green-mid before:font-extrabold before:text-xs">
                  ...
                  <li className="text-sm text-[#555] py-1.5 border-b border-cream-dark flex items-center gap-2 before:content-['✔'] before:text-green-mid before:font-extrabold before:text-xs">
                    Kepala TK: <strong>ST. Faoziyah Ulfah, M.Pd.I</strong>
                  </li>
                </ul>
                <Link
                  to="/sejarah"
              ...
              <div className="bg-[#e3f2fd] border-2 border-[#bbdefb] rounded shadow-card p-7" data-reveal="right">
                <h2 className="font-fredoka text-2xl text-green-dark mb-3">Fasilitas Pembelajaran</h2>
                <p className="text-[15px] text-[#555] mb-3">Sarana lengkap untuk mendukung tumbuh kembang optimal anak:</p>
                <ul>
                  {fasilitasList.map(f => (
                    <li
                      key={f.label}
        ...
        <section className="py-[70px] bg-green-light">
          <div className="max-w-[1100px] mx-auto px-7">
            ...
            <p
              ...
              data-delay="1"
            >
              Model sentra mendorong anak belajar sesuai minat dan tahap perkembangannya
            </p>
            <div className="grid gap-3.5 mt-8" style={{ gridTemplateColumns: 'repeat(auto-fill, minmax(210px, 1fr))' }}>
              {sentraList.map((s, i) => (
                <div
                  key={s.name}
                  data-reveal="scale"
                ...
                >
                  ...
                  <strong className="font-fredoka text-green-dark text-base">{s.name}</strong>
                  <p className="text-[13px] text-[#666] mt-1.5 font-semibold leading-relaxed">{s.desc}</p>
                </div>
              ))}
            </div>
          </div>
        ...
        <section className="py-[70px] bg-white">
          <div className="max-w-[1100px] mx-auto px-7">
            ...
            <p
              ...
              data-reveal="up"
            >
              Program harian membentuk karakter Profil Pelajar Pancasila
            </p>
            <div className="grid gap-4 mt-7" style={{ gridTemplateColumns: 'repeat(auto-fill, minmax(200px, 1fr))' }}>
              {pembiasaanList.map((item, i) => (
                ...
                >
                  ...
                  <strong className="font-fredoka text-green-dark text-sm">{item.t}</strong>
                  <p className="text-xs text-gray-soft mt-1 font-semibold">{item.d}</p>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="max-w-[1100px] mx-auto px-7">
            ...
            >
              <div data-reveal="left">
                <h2 className="font-fredoka text-2xl text-green-dark mb-4">Temukan Kami di Ciampea</h2>
                <p className="text-[#555] mb-3 font-semibold">
                  📍 Jl. Letnan Sukarna, Kp. Gedong RT 07/01,<br />Desa Benteng, Kec. Ciampea, Kab. Bogor 16620
                </p>
                <p className="text-[#555] mb-3 font-semibold">📞 0251-862325 / 0817 844 809</p>
                <p className="text-[#555] mb-3 font-semibold">✉️ tkmanbaul-ulum93@yahoo.co.id</p>
                <p className="text-[#555] mb-3 font-semibold">🕐 Senin–Jumat, 07.00–11.00 WIB</p>
        ...
        <section className="relative z-0 overflow-visible text-center bg-red-accent px-6 pt-20 pb-[90px]">
          ...
          />
          <div className="relative z-[1] max-w-[1100px] mx-auto px-7" data-reveal="up">
            <h2 className="font-fredoka text-[34px] text-white mb-3">Ajak Anak Anda Bergabung Bersama Kami!</h2>
            <p className="text-base text-white/[0.92] mb-7 font-semibold">
              Daftarkan putra-putri Anda sekarang dan berikan pendidikan terbaik sejak dini.
            </p>
            <Link
              to="/kontak"
